...
urlpatterns = [
    ...
    path('carrito/<int:producto_id>/', views.carrito_anyadir, name = 'carrito_anyadir'), # esta url es para probar que podemos guardar al carrito bien habría que hacerlo directamente con js desde 'producto.html'
